...
/**
 * @phpstan-implements ApiResponseCollectionInterface<BusinessUnit>
 */
class BusinessUnitsResponse implements ApiResponseCollectionInterface
{
    /** @phpstan-use ResponseCollectionTrait<BusinessUnit> */
