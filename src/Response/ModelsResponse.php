...
/**
 * @phpstan-implements ApiResponseCollectionInterface<Model>
 */
class ModelsResponse implements ApiResponseCollectionInterface
{
    /** @phpstan-use ResponseCollectionTrait<Model> */
