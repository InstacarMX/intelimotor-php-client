...
/**
 * @phpstan-implements ApiResponseCollectionInterface<Brand>
 */
class BrandsResponse implements ApiResponseCollectionInterface
{
    /** @phpstan-use ResponseCollectionTrait<Brand> */
